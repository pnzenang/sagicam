      ...
      <div className='container mx-auto flex flex-col p-6'>
        <div className='divide-y '>
          ...
          <div className='grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0'>
            <div className='flex items-center justify-center lg:col-span-1 col-span-full'>
              <PiIntersectLight className='w-16 h-16' />
            </div>
          ...
          <div className='grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0'>
            ...
            <div className='flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left'>
              ...
              <span className='mt-4  '>
                ...
                SAGICAM, the member is not fully registered and can not be
                covered.
              </span>
            </div>
          </div>
          <div className='grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0'>
            <div className='flex items-center justify-center lg:col-span-1 col-span-full'>
              <BsUmbrella className='w-16 h-16' />
            </div>
            <div className='flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left'>
              <span className='text-lg tracking-wider uppercase font-extrabold dark:text-violet-600'>
                Step 4
              ...
              <span className='mt-4 '>
                ...
                and the member&apos;s registration fee is received by SAGICAM,
                the member is covered, but will be able to received full payout
                after one year.
              </span>
            </div>
          </div>
          ...
          <div className='space-y-4'>
            <details className='w-full border rounded-lg'>
              <summary className='px-4 py-6 focus:outline-none focus-visible:dark:ring-violet-600'>
                Is SAGICAM the same thing as SAGI?
              </summary>
            ...
            <details className='w-full border rounded-lg'>
              <summary className='px-4 py-6 focus:outline-none focus-visible:dark:ring-violet-600'>
                How much is the contribution amount from SAGICAM when a member
                passes away.
              </summary>
              <p className='px-4 py-6 pt-0 ml-4 -mt-4 text-primary'>
                ...
                receives $6,000 when the loved ones is up to date in all his or her financial obligations.
              </p>
            </details>
            <details className='w-full border rounded-lg'>
              <summary className='px-4 py-6 focus:outline-none focus-visible:dark:ring-violet-600'>
            ...
            <details className='w-full border rounded-lg'>
              <summary className='px-4 py-6 focus:outline-none focus-visible:dark:ring-violet-600'>
                What is another relation between SAGI and SAGICAM?
              </summary>
              <p className='px-4 py-6 pt-0 ml-4 -mt-4 text-primary'>
